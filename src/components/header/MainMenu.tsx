            ...
            <ul className={`nav navbar-nav ${navbarPlacement ? navbarPlacement : ""}`} data-in="fadeInDown" data-out="fadeOutUp">
                            ...
                            <div className="col-menu-wrap">
                                <div className="menu-cal-items">
                                    ...
                                    <div className="col-menu">
                                        ...
                                        <ul className="menu-col">
                                            <li><Link href="/home-10">Full Width Slider</Link></li>
                                            <li><Link href="/home-11">Portfolio Carousel</Link></li>
                                            <li><Link href="/home-12">Interactive Portfolio</Link></li>
                                            <li><Link href="/home-13">Portfolio Masonary</Link></li>
                                            <li><Link href="/home-10-light">Full Width Slider Light</Link></li>
                                            <li><Link href="/home-11-light">Portfolio Carousel Light</Link></li>
                                            <li><Link href="/home-12-light">Interactive Portfolio Light</Link></li>
                                            <li><Link href="/home-13-light">Portfolio Masonary Light</Link></li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <li className="dropdown">
                    ...
                    <ul className="dropdown-menu">
                        ...
                        <li><Link href="/services-4">Service Version Four</Link></li>
                        ...
                        <li className="dropdown">
                            ...
                            <ul className="dropdown-menu">
                                ...
                                <li><Link href="/services-4-light">Service Version Four</Link></li>
