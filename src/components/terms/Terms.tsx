      ...
      <div className="container">
        ...
        <div className="first">
          ...
          <div>
            ...
            <p>
              i) Graphic Designing <br />
              ii) Digital Marketing <br />
              iii) Website Development <br />
              iv) Logo Designing <br />
              v) Branding
            </p>
          </div>
        </div>
        ...
        <div className="first">
          <div>
            <h3> 2. Right to Use the Services</h3>
          </div>

          <div>
            <p>
              DO IT CREATION has agreed to grant to Customer a non- exclusive,
              non-transferable and revocable right to use the Services in
              accordance with the terms and conditions of this Agreement, and
              Customer has agreed to use the Services subject to such terms and
              conditions. The non-exclusive, non-transferable and revocable
              right to use the Services will cease to exist when this Agreement
              is terminated as per clause 16 on Termination of this Agreement.
              It is clarified that DO IT CREATION is not creating any right or
              interest in the DO IT CREATION Numbers in favour of the Customer
              or its Authorized Users under this Agreement except for the
              limited purpose as defined in this Agreement. Also, DO IT CREATION
              or any of DO IT CREATION’ group companies and partners can use
              customer brand names, logos, and testimonials for
              marketing/promotion-related activities.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          <div>
            ...
            <p>
              Customer understands and agrees to the following restrictions and
              limitations that are applicable to the Customer’s right to use the
          ...
          <div>
            <p>
              ...
              the procedure as for registering a new subscriber is followed, and
              Services, or any other resources are issued. However, after the
              change in name the connection shall be treated as new connection.
              In such case, change in address is not permitted. Further, No
              Objection Certificate from the original user shall also be taken.
              ...
              and agrees that Customer is responsible for determining compliance
              ...
              to the API through e-mail to the primary admin and through popup
        ...
        <div className="first">
          <div>
            <h3>
              5. Customer’s Representations and Warranties Customer represent
              and warrant that:
            </h3>
          </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              6.1 During the Term of this Agreement, Customer will be able to
              download Customer Data and Servetel Data for the previous 1 Year.
              Customer Data and DO IT CREATION Data beyond this period may be
              made available to Customer on request, if commercially feasible.
              “Customer Data” means the data provided by Customer and/or their
              Authorized User(s) in the course of Customer’s use of the
              Services. Customer Data will include (as applicable) phone
              numbers, email addresses and names provided by Customer or their
              Authorized User(s) in relation to Customer’s use of the Services.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          <div>
            <h3> 8. Servetel Access</h3>
          </div>

          <div>
            <p>
              Customer and its Authorized User(s) agree to regularly regenerate
              the login passwords through DO IT CREATION dashboard in order to
              avoid unauthorized access to our Services through Customer
              account. In the event of any unauthorized access, Customer agrees
              to indemnify DO IT CREATION against all claims, loss or damage
              arising from such unauthorized access. Customer also agrees to pay
              the Charges for the use of the Services on account of such
              unauthorized access.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          <div>
            <h3>9. Regulatory Violation</h3>
          </div>

          <div>
            <p>
              Notwithstanding any other provision of this Agreement, a Customer
              agrees to indemnify DO IT CREATION against any liability that we
              may accrue due to a violation of the Regulations and other
              applicable law by such Customer and/or its Authorized User(s)
              while using DO IT CREATION Services first obtaining the
              Subscriber’s necessary consent in the appropriate manner under
              applicable law.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          <div>
            <h3> 10. Regulatory Disclosure</h3>
          </div>

          <div>
            <p>
              Customer understands and agrees that in order to comply with the
              applicable laws, Servetel may either review or disclose the
              content of the conference calls or messages transmitted by
              Customer and/or Customer’s Authorized User(s) using DO IT CREATION
              Services under this Agreement and perform any other act, as may be
              required by law from DO IT CREATION. On request, Customer’s point
              of contact will provide all information that Servetel seeks within
              twenty-four Enhanced Customer Support. Customer agrees to provide
              all information required for compliance with the applicable laws,
              and in such a manner and in such a timeline so as not to cause
              Servetel or a service provider of Servetel, to be in violation of
              any applicable laws.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              Subject to clause 13 (Limitation of Liability) of this Agreement,
              DO IT CREATION and the Customer agree that: Customer (hereinafter
              referred to as the “Indemnifying Party”), at their sole expense,
              will defend, indemnify and hold DO IT CREATION, its directors and
              employees (collectively referred to as the “Indemnified Party”)
              harmless from and against any, damages, losses, settlements,
              liabilities, penalties, fines, costs and expenses (including, but
              not limited to, reasonable attorneys’ fees) resulting from any
              claim, suit, action or proceeding (hereinafter referred to as the
              “Claim”) against Servetel arising from or related to a breach or
              alleged breach of any provision of this Agreement by Customer
              and/or their Authorized User(s). The Indemnifying Party’s
              indemnification obligations under this clause 19 are conditioned
              upon the Indemnified Party: (a) giving notice of the Claim to the
              Indemnifying Party once the Indemnified Party becomes aware of the
              Claim; (b) However, it is clarified that Indemnified Party
              reserves the right to select and appoint its separate counsel in
              connection with the Claim. It is further clarified that if in the
              Indemnified Party’s view, the Indemnifying Party has not responded
              to and/or defended the Claim to the satisfaction of the
              Indemnified Party, the Indemnified Party reserves the right to
              assume control of the defence at the cost of the Indemnifying
              Party; and (c) providing reasonable coopera- tion to the
              Indemnifying Party and, at the Indemnifying Party’s request and
        ...
        <div className="first">
          ...
          <div>
            <p>
              Without limiting DO IT CREATION’ express warranties and
              obligations under this Agreement, DO IT CREATION hereby disclaims
              any and all other warranties, express or implied, including but
              not limited to warranties of merchantability, title,
              non-infringement, and fitness for a particular purpose and
              warranties related to third-party equipment, material, services or
              software. Our Services are provided on “as is” basis to the
              fullest extent permitted by law. To the extent, this disclaimer
              conflicts with applicable law, the scope and duration of any
              applicable warranty will be the minimum permitted under that law.
              DO IT CREATION can guarantee services & issue from its own network
              only. DO IT CREATION shall not be liable, to the customer for any
              loss or damage suffered by the Customer due to any act or omission
              of third parties, If there is an issue at telephony operator or
              internet provider and it results in hamper or shutdown in our
              services, then DO IT CREATION will not be liable for the business
        ...
        <div className="first">
          ...
          <div>
            <p>
              ...
              Customer agrees that clauses (Customer’s Representations and
              Warranties), (Intellectual Property Rights), (Confidentiality
              Obligations), (Limitation of Liability), (Indemnity Obligations),
        ...
        <div className="first">
          ...
          <div>
            <p>
              All designs, concepts, drafts, and final artworks created by Do It
              Creation remain the exclusive intellectual property of Do It
              Creation. No design may be used, published, reproduced, modified,
              registered, shared, or commercialized in any form without a formal
              Copyright Declaration issued by Do It Creation. The Copyright
              Declaration is provided only after full and final payment of the
              agreed project amount is received. Until such payment is completed
              and the declaration is issued, all rights, ownership, and usage of
              the design remain solely with Do It Creation. Any unauthorized use
              prior to rights transfer will be considered a violation of
              intellectual property laws and may invite legal action.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              DO IT CREATION shall not be held responsible for any delay, loss,
              or inconvenience if the Customer fails to finalize the payment.
              Furthermore, no files, designs, credentials, or project access
              will be handed over until full and final payment has been
              received.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              Customer understands and agrees that DO IT CREATION is operated in
              India and will be deemed to be solely based in India. This
              Agreement and any dispute or claim (including non-contractual
              disputes or claims) arising out of or in connection with it or its
              subject matter or formation will be governed by and construed in
              accordance with the laws of India, without regard to conflicts of
              laws and principles that would cause laws of another jurisdiction
              to apply.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              ...
              to the terms of this Agreement or its termination, including the
              ...
              Arbitration & Conciliation Act, 1996, or any statutory amendments,
              modifications or re-enactment thereof for the time being in force.
              A Sole Arbitrator, who shall be nominated by Servetel, shall hold
              the arbitration proceedings. The Courts at Delhi shall, to the
              specific exclusion of all other courts, alone have the exclusive
              jurisdiction in all matters arising out of/or concerning this
              Agreement, regardless of the place of execution or subject matter
              of this Agreement.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              ...
              may be transferred, assigned or delegated by a party, by operation
              of law or otherwise, without the prior written consent of the
              other party. Notwithstanding the foregoing, each party will have
              the right to assign this Agreement to any successor to
              substantially all of its business or assets, whether by merger,
              sale of assets, sale of stock, reorganization or otherwise.
        ...
        <div className="first">
          ...
          <div>
            <p>
              ...
              all other provisions of this Agreement will nonetheless remain in
              full force and effect so long as the economic or legal substance
              of the transactions contemplated by this Agreement is not affected
              in any manner adverse to any party. Upon such determination that
              any provision is invalid, illegal, or incapable of being enforced,
              if required, the parties will negoti- ate in good faith to modify
              this Agreement so as to affect the original intent of the parties
        ...
        <div className="first">
          ...
          <div>
            <p>
              Nothing in this Agreement is intended to, or will be deemed to,
              establish any partnership or joint venture between any of the
              parties, constitute any party as the agent, franchisor,
              franchisee, employee, representative, owner or partner of the
              other party, or authorize any party to make or enter into any
              commitments for or on behalf of any other party, and the
              relationship between the parties will only be that of independent
              contractors.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              ...
              required or may be given under this Agreement will be in writing
              and will be deemed to have been duly given: when received, if
              personally delivered and an acknowledgment in writing is obtained;
              when transmitted, if transmitted by e-mail; upon receipt of
              acknowledgement, if sent by registered post with acknowledgement
              due. In each ase notice will be sent to the respective addresses
              of the parties set forth below. Any change in the address of a
              party should be notified to the other party in a manner set out
              under this clause 24. Any notice or other communication given to a
              party under or in connection with this Agreement will be addressed
              to: If to Servetel, at contact@doitcreation.com If to the
              Customer, customer’s registered email id as specified in the
              Company Info Page.
            </p>
          </div>
        </div>
        ...
        <div className="first">
          ...
          <div>
            <p>
              DO IT CREATION may amend this Agreement (including any policies,
              such as the Privacy Policy that are incorporated into this
              Agreement) at any time. We will keep Customer informed of the said
