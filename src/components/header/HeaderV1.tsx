                    ...
                    <div className="container-full d-flex justify-content-between align-items-center" >
                        <div className="navbar-header">
                            ...
                            <Link className="navbar-brand" href="/">
                                <Image src={logoLight} style={{width: '330px', height: "auto", objectFit: "cover"}} className="logo logo-display" alt="Logo" />
                                <Image src={logoLight} style={{width: '330px', height: "auto", objectFit: "cover"}} className="logo logo-scrolled" alt="Logo" />
                                <Image src={logo} style={{width: '350px', height: "auto", objectFit: "cover"}} className="logo-dark" alt="Logo" />
                            </Link>
                        </div>
