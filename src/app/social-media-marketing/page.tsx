...
import BreadHeader from "@/components/social-marketing-breadcrumb/BreadHeader"
...
import {ServiceDetailsContent} from "@/components/social-marketing-service/ServiceDetailsContent"
import { ClientTestimonials } from "@/components/testimonials/ClientTestimonials"

const packagingDesingPage = () => {
    return(
        <>
            <HeaderV1/>
            <BreadHeader title="SOCIAL MEDIA MARKETING SERVICES" 
            description="Turn Your Brand Into a High-Impact Digital Powerhouse"/>
...
export default packagingDesingPage