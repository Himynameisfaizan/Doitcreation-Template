      ...
      >
        ...
        <div className="container">
          ...
          <p className="do-it-para">
            An exceptional application goes beyond functionality, defining how
            your brand is perceived in a digital-first world. With 8+ years of
            expertise, Do It Creation crafts sophisticated, high-performance
            applications focused on precision, elegance, and scalability—helping
            you create impact, elevate user experience, and build lasting
            digital excellence.
          </p>
        </div>
      </div>
