                            ...
                            <div className="col-tact-stye-one col-lg-4">
                                <div className="contact-style-one-info">
                                    <ul className="contact-address">
                                        <li>
                                            <a className="phone-link" href="tel:9560237516"><i className="fas fa-user-headset" />+91 9560237516</a>
                                        </li>
                                        <li>
                                            <div className="info">
                                                <h4>Location</h4>
                                        ...
                                        <li>
                                            <div className="info">
                                                ...
                                                <a href="mailto:contact@doitcreation.com">contact@doitcreation.com</a>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="info">
